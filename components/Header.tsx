...
import { linkClick, toggleMenu } from "../components/utility/utils";
      ...
      <header className="header">
        <div className="header__builder">
          <div className="row">
                ...
                <Link href="/" legacyBehavior>
                  <a>
                    <Image
                      ...
                      width={70}
                      height={70}
                      src="/assets/images/logo_ca_bo.png"
                      alt="fff"
                    />
                  </a>
                </Link>
            ...
            <div className="col-xs-12 col-sm-12 col-md-8 col-lg-8 align-right">
                <a className="icon" href="http://chondromollikaahmed.me" style={{ fontSize: '1.3rem', paddingRight: '20px' }}>
                👩‍💻
                </a>
